...
//task 4 does not exist in the pdf
...
function chap14to16Ques9(){
    ...
    var color = ["red", "yellow" , "pink" , "brown"];
    document.write("Here is a default array : " + color + "<br/>");
    var add_color_beg = prompt("enter color name to add in beginning");
     color.unshift(add_color_beg);
     document.write("array after adding color in the beginning : " + color + "<br/>");

     var add_color_end = prompt("enter color name to add in the end");
     color.push(add_color_end);
     document.write("array after adding color in the end : " + color + "<br/>");

     color.unshift("blue","light blue");
     document.write("array after adding two colors in the beginning : " + color + "<br/>");

     color.shift();
     document.write("array after removing a color at the beginning : " + color + "<br/>");

     color.pop();
     document.write("array after removing a color at the end: " + color + "<br/>");

     var add_color_index = prompt("enter index no where u want to add color ");
     var add_color_name = prompt("enter color name ");
     color.splice(add_color_index , 0 , add_color_name);
     document.write("array after adding a color at desired position: " + color + "<br/>");

     var rem_color_index = prompt("enter position no from where u want to delete color ");
     var rem_color_qty = prompt("enter how many colors u want to remove ");
     color.splice(rem_color_index,rem_color_qty);
     document.write("array after adding a color at desired position: " + color + "<br/>");
